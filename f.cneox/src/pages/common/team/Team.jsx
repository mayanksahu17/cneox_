...
const teamMembers = [
  {
    ...
    bio: `With nearly two decades of experience in marketing, business operations, and strategic growth, Adrian Cadiz leads CNEOX as CEO. His expertise extends to the renewable energy sector, where he has played a key role in integrating financial solutions with solar and EV projects. Under his leadership, CNEOX continues to drive innovation, efficiency, and expansion across all operations.`,
    facebook: "#",
    linkedin: "#",
  },
  {
    ...
    bio: `As the Chief Marketing Officer, Edward Barrington oversees all marketing initiatives at CNEOX. His expertise in brand development and market expansion plays a crucial role in growing the company's global presence.`,
    facebook: "#",
    linkedin: "#",
  },
  {
    ...
    bio: `Anee Sandrova manages relations and operations in the Netherlands, particularly overseeing the CNEOX solar plant in Groningen. Her role ensures seamless coordination and development of our renewable energy projects.`,
    facebook: "#",
    linkedin: "#",
  },
  {
    ...
    bio: `Sophie Taylor and her team handle the financial strategies at CNEOX, making critical decisions on investments and resource allocation. Her expertise ensures sustainable financial growth and stability.`,
    facebook: "#",
    linkedin: "#",
  },
  {
    ...
    bio: `Joseph Carter leads the administrative division, handling user inquiries and ensuring smooth internal operations. His dedication to efficiency and customer support enhances the overall experience for CNEOX members.`,
    facebook: "#",
    linkedin: "#",
  },
];
