...
const Navbar = ({ mobileMenu, setMobileMenu, color }) => {
  ...
  return (
    <div>
      {/* Main navigation */}
      <div className="flex items-center justify-between px-4 text-lg bg-black  ">
          ...
          <Link to="/" className="flex items-center">
            <div className="relative h-18 w-36">
              <div className="flex items-center">
                ...
                <div>
                  {/* <div className="text-xs text-white-500">Invest Owen Risk</div> */}
                </div>
              </div>
            </div>
          </Link>
            ...
            <li
                ...
                >
                  ...
                  {activeDropdown === "services" && (
                    <div className="absolute left-0 z-10 w-48 py-2 bg-black rounded-md shadow-md top-full">
                      <Link
                        to="/pages/team"
                        className="block px-4 py-2 text-white hover:bg-gray-100 hover:text-yellow-500"
              ...
              <li
                ...
                >
                  ...
                  {activeDropdown === "projects" && (
                    <div className="absolute left-0 z-10 w-56 py-2 bg-black rounded-md shadow-md top-full">
                      <Link
      ...
      {/* Mobile menu */}
      {isMenuOpen && (
        <div className="pb-6 overflow-y-auto bg-black lg:hidden">
