          ...
          >
            <div className="text-white space-y-6 text-center max-w-2xl">
              ...
              <div className="flex flex-wrap gap-4 pt-4 justify-center">
                <Link
                  to="/sign-up"
                  className="flex items-center gap-2 bg-yellow-500 hover:bg-gray-2000 text-white px-6 py-3 rounded-md transition-colors"
                >
                ...
                <button
                  ...
                  className="flex items-center gap-2 bg-transparent hover:bg-green-700 text-white px-6 py-3 rounded-md transition-colors border-2 border-yellow-600"
                >
